...
export default function Profile() {
  ...
  return (
    <div className="prof-page">
      ...
      <style>{`
        .prof-page { min-height: 100vh; background: var(--bg-surface); display: flex; flex-direction: column; font-family: 'Inter', sans-serif; }
        ...
        .prof-back-btn { width: 40px; height: 40px; border-radius: 12px; background: var(--bg-card); border: none; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 2px 8px rgba(0,0,0,0.03); transition: transform 0.2s; }
        ...
        .prof-card { background: var(--bg-card); border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); border: 1px solid rgba(0,0,0,0.02); }
        ...
        .prof-name { font-size: 20px; font-weight: 800; color: var(--text-primary); letter-spacing: -0.3px; margin-bottom: 4px; }
        .prof-member-since { font-size: 12px; color: var(--text-muted); font-weight: 500; margin-bottom: 16px; }
        ...
        .prof-field label { font-size: 11.5px; font-weight: 700; color: var(--text-primary); margin-left: 2px; }
        
        .prof-input-wrap { position: relative; display: flex; align-items: center; }
        .prof-input-icon { position: absolute; left: 14px; color: var(--text-muted); pointer-events: none; }
        .prof-input { width: 100%; background: var(--bg-card); border: 1.5px solid var(--border); border-radius: 12px; padding: 12px 14px; font-size: 14px; font-family: 'Inter', sans-serif; color: var(--text-primary); outline: none; transition: border-color 0.2s; box-shadow: 0 2px 8px rgba(0,0,0,0.01); }
        .prof-input.icon-left { padding-left: 40px; }
        .prof-input:focus { border-color: #4a7c59; }
 
        .prof-list-card { background: var(--bg-card); border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.02); overflow: hidden; }
        .prof-list-item { display: flex; align-items: center; justify-content: space-between; padding: 16px; background: var(--bg-card); transition: background 0.2s; }
        .prof-list-item.clickable { cursor: pointer; }
        .prof-list-item.clickable:active { background: #f9fafb; }
        .prof-list-sep { height: 1px; background: var(--bg-input); margin: 0 16px; }
        .prof-item-left { display: flex; align-items: center; gap: 12px; font-size: 13.5px; font-weight: 600; color: var(--text-primary); }
        ...
        .prof-val-text { font-size: 12px; font-weight: 600; color: var(--text-muted); }
        ...
        .prof-toggle.on { background: var(--bg-card); border-color: #4a7c59; }
        .prof-toggle.off { background: var(--border); }
        ...
        .prof-footer { text-align: center; font-size: 11px; font-weight: 600; color: var(--text-muted); margin-top: 8px; display: flex; align-items: center; justify-content: center; gap: 4px; }
      `}</style>
    </div>
  );
}
